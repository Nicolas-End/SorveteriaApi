...
simulação de um cenário real de aplicação comercial.
---
## INSTRUÇÃO DE INSTALAÇÃO
### Pré Requsitos

- Banco de Dados Postgress ou qualquer banco de dados Relacional
- Docker 
- Java 25 ou posteriores

### Etapas
- Configure seu arquivo .env de acordo com o exemplo na pasta .env.example na pasta resources
-


[Endopoints Disponiveis](https://lhfkl1lkiu.apidog.io/)
